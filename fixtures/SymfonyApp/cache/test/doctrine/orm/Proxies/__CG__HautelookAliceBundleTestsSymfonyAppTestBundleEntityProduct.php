 ...
 */
class Product extends \Hautelook\AliceBundle\Tests\SymfonyApp\TestBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'price', 'description', 'brand'];
        }
